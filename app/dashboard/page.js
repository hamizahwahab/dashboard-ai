...
import { MessageCircle, X, Send, Sparkles, Loader2, Calendar } from 'lucide-react';
...
export default function AIChat() {
  ...
  const [messages, setMessages] = useState([
    { role: 'ai', text: 'Hello 👋 I am your **Nova AI** assistant. How can I help you today?' }
  ]);
  ...
  return (
    <div>
        ...
        {/* Chat Window */}
        {isOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-white md:inset-auto md:bottom-4 md:right-4 md:bg-transparent">
            <div className="flex h-screen w-screen flex-col md:h-[80vh] md:w-[90%] md:max-w-md md:rounded-2xl overflow-hidden border border-slate-200 bg-white shadow-2xl transition-all animate-in slide-in-from-bottom-4 dark:border-dark-border dark:bg-dark-card">
              ...
              <div className="flex items-center justify-between bg-brand-900 px-4 py-3 text-white">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-bold tracking-tight">Nova AI</span>
                </div>
                <button 
        ...
        {!isOpen && (
          <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50">
            <button 
              ...
              className="flex h-14 w-14 items-center justify-center rounded-full text-white shadow-xl transition-all active:scale-95 bg-brand-900 hover:shadow-brand-900/30"
            >
